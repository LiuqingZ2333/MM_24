...
class Dataset(object):
    def __init__(self, args, vocab, tokenizer):
        ...
        self.corpus_path = args.corpus_path  # 原始.txt数据的路径
        self.dataset_path = args.dataset_path  # 生成.pt数据的路径
        self.seq_length = args.seq_length  # 1024
        self.seed = args.seed
    ...
    def worker(self, proc_id, start, end):
        ...
        with open(self.corpus_path, mode="r", encoding="utf-8") as f:
            ...
            while True:
                ...
                document = self.tokenizer.convert_tokens_to_ids(self.tokenizer.tokenize(line)) # 将所有str信息转化成token信息
